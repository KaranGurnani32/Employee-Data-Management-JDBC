...
public class EmployeeManagerRunner {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            //one object created (singleton method)
            //here DriverManager.getConnection() is an object
            connection = DriverManager.getConnection(url, userName, password);

            //build query
            //statement = object.methodname();
            //statement in itself is an object
    ...
    private static void insertEmployee() throws SQLException{
        ...
        String query = "insert into employees (name, department, salary) value ('" + employee.getName()
